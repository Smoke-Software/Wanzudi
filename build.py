...
os.system('clear')
print(Fore.YELLOW + '-----------------------------------------')
print(Fore.YELLOW + '|' + Fore.BLUE +  "        Еще больше уникальных скриптов, софта и схем на нашем Telegram канале https://t.me/mamontyatina     " + Fore.YELLOW + '|')
print(Fore.YELLOW + '-----------------------------------------')
...
print("Бот запущен! Еще больше уникальных скриптов, софта и схем на нашем Telegram канале https://t.me/mamontyatina ")
